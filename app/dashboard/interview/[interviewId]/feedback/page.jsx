...
const Feedback = ({ params }) => {
  ...
  const GetFeedback = async () => {
    try {
      console.log("Fetching feedback for interview:", params.interviewId); // Debug log
      ...
      console.log("Feedback results:", result); // Debug log

      if (!result || result.length === 0) {
        toast.error("No feedback found for this interview");
        return;
      }
